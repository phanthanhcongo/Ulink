...
export function ContactRequestStatusToggle({ id, currentStatus }: ContactRequestStatusToggleProps) {
  ...
  return (
    <button
      ...
      disabled={isPending}
      className="inline-flex items-center gap-2 rounded-[3px] border border-slate-200 bg-white px-3 py-2 text-caption-responsive font-bold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
    >
