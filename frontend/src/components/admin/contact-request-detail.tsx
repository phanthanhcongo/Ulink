    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <Link
          ...
          className="inline-flex items-center gap-1 text-body-regular text-slate-500 hover:text-slate-900 transition-colors"
        >
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <span
            className={`mt-3 inline-flex items-center rounded-[3px] px-3 py-1 text-caption-responsive font-bold ${statusClasses}`}
          >
            {statusLabel}
          </span>
        </div>
        ...
        <div className="flex flex-col items-start gap-2 sm:items-end">
          <span className="inline-flex items-center gap-2 rounded-[3px] bg-cyan-50 px-3 py-1 text-caption-responsive font-bold text-cyan-700 w-fit">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        <section className="lg:col-span-7 rounded-[3px] border border-slate-100 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
            ...
            <h2 className="text-body-regular font-bold text-slate-900">Nội dung liên hệ</h2>
          </div>

          <div className="mt-5 space-y-5">
            <div>
              <p className="text-caption-responsive font-bold uppercase tracking-wider text-slate-400">
                Chủ đề
              </p>
              <p className="mt-1 text-body-regular font-semibold text-slate-900">{request.subject}</p>
            </div>
            ...
            <div>
              ...
              <div className="mt-1 rounded-[3px] border border-slate-100 bg-slate-50 p-4 text-body-regular leading-7 text-slate-700 whitespace-pre-wrap">
                {request.message}
              </div>
            </div>
          </div>
        ...
        <section className="lg:col-span-5 rounded-[3px] border border-slate-100 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
            ...
            <h2 className="text-body-regular font-bold text-slate-900">Thông tin người gửi</h2>
          </div>

          <dl className="mt-5 space-y-4 text-body-regular">
  ...
  return (
    <div className="flex items-start gap-3 rounded-[3px] border border-slate-100 bg-slate-50/50 px-4 py-3">
      ...
      <div className="min-w-0 flex-1">
        <dt className="text-caption-responsive font-bold uppercase tracking-wider text-slate-400">{label}</dt>
        <dd className="mt-1 break-words text-body-regular font-semibold text-slate-900">{value}</dd>
      </div>
    </div>
  );
}
