              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-0.5">
                    <h4 className="text-caption-responsive font-bold text-primary leading-snug">
                      {prop.title}
                    </h4>
                    <p className="text-caption-responsive text-slate-400 leading-relaxed font-semibold">
                      {prop.desc}
                    </p>
                  </div>
                </div>
