    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-slate-100">
      ...
      <section id="cleanroom" className="scroll-mt-36 space-y-4">
        <div className="space-y-1">
          <span className="inline-block bg-[#E8F1FF] text-brand text-caption-responsive font-bold uppercase tracking-wider px-3 py-1">
        ...
        <div className="grid grid-cols-5 gap-2">
          {industryData.cleanroomCategories.map((cat, idx) => (
            ...
            >
              ...
              <span className="text-caption-responsive text-slate-500 font-bold mt-2 text-center line-clamp-2 leading-tight min-h-[26px] flex items-center justify-center px-0.5">
                {cat.name}
              </span>
            </Link>
          ))}
