    ...
    <div className="min-h-screen bg-card text-slate-900 font-sans">
      ...
      <section className="relative w-full overflow-hidden bg-slate-950 flex flex-col justify-center min-h-[460px] md:min-h-[500px]">
        ...
        <div className="page-container z-20 pt-28 pb-20 relative flex flex-col items-start justify-center h-full">
          ...
          <nav className="flex items-center gap-1.5 text-caption-responsive text-white/70 font-semibold mb-6">
          ...
          <div className="flex overflow-x-auto no-scrollbar py-0.5 gap-8 scroll-smooth">
            {tabs.map((tab) => (
              <a
                ...
                className={`py-4.5 text-caption-responsive  leading-relaxed font-bold transition-all relative border-b-2 whitespace-nowrap leading-none ${activeTab === tab.id
      ...
      <section id="overview" className="scroll-mt-36 py-16 lg:py-20 w-full bg-white">
        <div className="page-container grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="text-caption-responsive leading-relaxed text-slate-600 font-medium space-y-4 max-w-4xl">
              {industryData.slug === 'pharmaceutical-cosmetics' ? (
                <>
                  <p>
            ...
            <div className="space-y-5">
              ...
              <ul className="space-y-4">
                {industryData.whyUsList.map((item, idx) => (
                  <li key={idx} className="flex gap-3 items-start text-caption-responsive leading-relaxed text-slate-600 font-medium">
              ...
              return (
                ...
                >
                    ...
                    <div className="p-5 space-y-3">
                      ...
                      <ul className="space-y-1.5">
                        {item.bullets.map((bullet, bIdx) => (
                          <li key={bIdx} className="flex gap-2 items-start text-caption-responsive text-slate-500 font-semibold leading-snug">
                  ...
                  <div className="px-5 pb-5 pt-2">
                    <Link
                      href={item.href}
                      className="text-caption-responsive font-bold text-blue-600 hover:text-blue-700 inline-flex items-center gap-1 transition-colors"
                    >
