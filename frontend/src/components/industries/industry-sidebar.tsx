    ...
    <div className="space-y-6">
      <div className="sticky top-[152px] space-y-6">
        ...
        <div className="bg-card/60 border border-slate-100 p-6 sm:p-8 shadow-sm space-y-5">
          <h3 className="text-body-regular font-bold text-primary border-b pb-3 flex items-center gap-2">
            <ShieldCheck className="h-5 w-5 text-brand" />
            {industryData.whyUsTitle}
          </h3>
          <ul className="space-y-3.5">
            {industryData.whyUsList.map((item, idx) => (
              <li key={idx} className="flex gap-2.5 items-start text-caption-responsive leading-relaxed text-slate-600 font-medium">
            ...
            {certifications.map((cert: any, idx: number) => {
              ...
              return (
                <div key={idx} className="flex flex-col items-center text-center">
                  ...
                  <span className="text-caption-responsive font-bold text-primary leading-tight block">
                    {cert.name}
                  </span>
        ...
        <div className="bg-card/60 border border-slate-100 p-6 sm:p-8 shadow-sm space-y-5">
          ...
          >
            ...
            <div className="space-y-0.5">
              <h4 className="text-caption-responsive leading-relaxed font-bold text-primary leading-snug">
                {industryData.catalogue.title}
              </h4>
              <p className="text-caption-responsive text-slate-400 font-bold uppercase tracking-wider">
