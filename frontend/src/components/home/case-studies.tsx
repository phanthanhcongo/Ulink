...
export function CaseStudies() {
  ...
  return (
    <section className="page-container py-8 lg:py-8 xl:py-8">
      {/* ── SECTION HEADER BAR ── */}
      <SectionHeader
      ...
      <div className="mt-10 flex justify-center sm:mt-12">
        <Link
          href="/resources"
          className="inline-flex items-center justify-center rounded-[3px] bg-brand px-8 py-3 text-body-large font-semibold text-white shadow-sm transition-all hover:bg-brand-strong card-hover-standard active:scale-95"
        >
          {t('caseStudy.viewAll')}
        </Link>
      </div>
