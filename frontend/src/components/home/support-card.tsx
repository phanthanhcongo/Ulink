...
export function SupportCard({ title, desc, icon: IconComp }: SupportCardProps) {
  return (
    <div className="group flex flex-col border border-border bg-white p-4 shadow-sm sm:p-5 lg:p-6 cursor-pointer transition-all duration-300 hover:bg-slate-50/20 hover:z-10 relative">
