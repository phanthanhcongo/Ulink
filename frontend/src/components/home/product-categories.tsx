        ...
        {topTwoCards.map((card) => (
          ...
          >
            ...
            <div className="flex flex-1 flex-col p-5 sm:p-6 lg:p-6 xl:p-8">
              <h3 className="flex items-center gap-2 text-[20px] font-bold text-slate-900 leading-[28px] sm:text-[22px] md:text-[22px] lg:text-[22px] xl:text-[22px] group-hover:text-brand transition-colors">
                <span className={card.diamondColor}>◇</span> {card.title}
              </h3>
              <p className="mt-2 text-[14px] leading-[22px] text-slate-600 sm:text-[16px] sm:font-normal sm:leading-[24px] lg:text-[16px] xl:text-[16px] lg:font-normal lg:leading-[24px]">
                {card.description}
              </p>
              ...
              <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
                {card.items.map((item, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-2 text-[14px] text-slate-700 transition-colors sm:text-[14px] sm:leading-[20px] lg:text-[14px] xl:text-[14px] font-normal"
                  >
                    <Image
              ...
              <div className="mt-8 flex justify-end pt-3 border-t border-slate-100">
                <span className="inline-flex items-center gap-1.5 text-[16px] font-bold text-brand transition-all sm:text-[16px] lg:text-[16px] group-hover:gap-2.5">
          ...
          >
            ...
            <div className="flex flex-1 flex-col p-5 sm:p-6 lg:p-6 xl:p-8">
              <div>
                ...
                <p className="text-[13px] leading-[18px] text-slate-600 sm:text-[16px] sm:font-normal sm:leading-[24px] lg:text-[16px] xl:text-[16px] lg:font-normal lg:leading-[24px]">
                  {card.description}
                </p>
              </div>
              ...
              <div className="mt-6 flex justify-end pt-3 border-t border-slate-100">
                <span className="inline-flex items-center gap-1.5 text-[14px] font-medium text-brand transition-all sm:text-[16px] lg:text-[16px] group-hover:gap-2.5">
