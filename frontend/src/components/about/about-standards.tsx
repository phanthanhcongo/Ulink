...
export async function AboutStandards() {
  const t = await getTranslations('aboutHub');
  const standards = [
    { icon: ShieldCheck, title: t('iso.quality'), tag: 'ISO 9001:2015', desc: t('iso.desc'), color: 'text-[#1769e2] bg-[#1769e2]/10', tagColor: 'text-[#1769e2]' },
    { icon: Leaf, title: t('iso.environment'), tag: 'ISO 14001:2015', desc: t('iso.desc'), color: 'text-[#10b981] bg-[#10b981]/10', tagColor: 'text-[#10b981]' },
    { icon: ClipboardCheck, title: t('iso.safety'), tag: 'ISO 45001:2018', desc: t('iso.desc'), color: 'text-[#ef4444] bg-[#ef4444]/10', tagColor: 'text-[#ef4444]' }
  ];
  return (
