...
export function ContactSuccessHero() {
  return (
    <section className="py-12 flex flex-col items-center text-center max-w-3xl mx-auto">
      ...
      {/* Description */}
      <p className="mt-4 text-body-large font-medium leading-relaxed text-slate-600 max-w-2xl">
      ...
      <div className="mt-8">
        <Link
          href="/"
          className="inline-flex items-center justify-center gap-2 rounded-[3px] bg-blue-600 px-7 py-3 text-body-large font-semibold text-white shadow-md hover:bg-blue-700 transition-all hover:shadow-lg"
        >
