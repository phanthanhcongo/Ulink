...
export function ApplySuccessHero() {
  return (
    <section className="py-10 flex flex-col items-center text-center max-w-3xl mx-auto">
      ...
      {/* Description */}
      <p className="mt-4 text-body-regular text-slate-600 leading-relaxed max-w-2xl">
      ...
      <div className="mt-6">
        <Link
          href="/"
          className="inline-flex items-center justify-center gap-2 rounded-[3px] border border-slate-200 bg-white px-6 py-2.5 text-body-regular font-semibold text-blue-600 shadow-sm hover:bg-slate-50 hover:border-blue-200 transition-all"
        >
