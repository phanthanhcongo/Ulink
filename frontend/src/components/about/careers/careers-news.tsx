    ...
    <section className="py-12 lg:py-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col gap-3">
          ...
          <h3 className="text-xl sm:text-[22px] font-extrabold text-slate-900 leading-snug">
            {featuredNews.title}
          </h3>
        ...
        {newsList.map((item) => (
          <div key={item.id} className="flex flex-col gap-3 group">
            ...
            <div className="flex flex-col flex-1 gap-2">
              ...
              <h4 className="text-[15px] sm:text-[16px] font-extrabold text-slate-800 leading-snug line-clamp-2 group-hover:text-blue-600 transition-colors">
                {item.title}
              </h4>
              ...
              <Link
                ...
                className="text-xs sm:text-sm font-bold text-blue-600 hover:text-blue-700 inline-flex items-center mt-auto pt-2"
              >
                Đọc thêm
              </Link>
            </div>
