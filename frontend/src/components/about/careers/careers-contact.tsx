      ...
      <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-12 lg:gap-8 items-stretch">
        ...
        <div className="lg:col-span-5 flex flex-col justify-between gap-6">
          <div className="flex flex-col gap-4 sm:gap-6">
            <h2 className="text-section-title sm:text-hero-title lg:text-hero-title font-bold text-slate-900">
              Liên hệ & Địa chỉ
            </h2>
            ...
            <div className="flex flex-col gap-2 sm:gap-3">
              ...
              <div className="border-l-[3px] border-l-blue-600 bg-white p-3 sm:p-4 rounded-[3px] border border-slate-200/80 shadow-xs flex flex-col gap-1">
        ...
        <div className="lg:col-span-7 h-full">
          <div className="relative w-full h-full min-h-[300px] sm:min-h-[400px] lg:min-h-[580px] overflow-hidden rounded-[3px] border border-slate-200/80 shadow-xs">
            <iframe
