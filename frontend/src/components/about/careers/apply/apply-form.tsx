    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-8 py-8">
      ...
      <div className="rounded-[3px] bg-white p-6 border border-slate-100 shadow-sm flex flex-col gap-4">
        <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
          ...
          <h2 className="text-section-title font-bold text-slate-900">Thông tin cá nhân</h2>
        </div>
      ...
      <div className="rounded-[3px] bg-white p-6 border border-slate-100 shadow-sm flex flex-col gap-4">
        <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
          ...
          <h2 className="text-section-title font-bold text-slate-900">Trình độ học vấn</h2>
        </div>
      ...
      <div className="rounded-[3px] bg-white p-6 border border-slate-100 shadow-sm flex flex-col gap-4">
        <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
          ...
          <h2 className="text-section-title font-bold text-slate-900">Kinh nghiệm làm việc gần nhất</h2>
        </div>
      ...
      <div className="rounded-[3px] bg-white p-6 border border-slate-100 shadow-sm flex flex-col gap-4">
        <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
          ...
          <h2 className="text-section-title font-bold text-slate-900">Hồ sơ đính kèm (CV)</h2>
        </div>
