  ...
  return (
    <section className="py-8 lg:py-12">
      <div className="flex flex-col gap-4 max-w-3xl mb-8">
        <span className="inline-flex w-fit items-center rounded-full bg-blue-50 px-3.5 py-1 text-[13px] sm:text-[14px] lg:text-[16px] font-bold uppercase tracking-wider text-blue-700 ring-1 ring-inset ring-blue-700/10">
        ...
        <p className="text-[15px] sm:text-[16px] lg:text-[18px] font-medium leading-relaxed text-slate-600">
