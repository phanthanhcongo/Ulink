...
export default function HubOverview({ locale }: HubOverviewProps) {
  ...
  return (
    <section className="w-full bg-white pt-32 pb-16 sm:pt-40 sm:pb-20 lg:pt-48 lg:pb-24 border-b border-slate-100">
      <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-8 lg:px-16 flex flex-col gap-10">
        ...
        {/* === Part 2: Metrics Bar === */}
        <div className="w-full bg-[#E8F0FE]/40 rounded-[3px] border border-blue-100/80 p-5 sm:p-8">
