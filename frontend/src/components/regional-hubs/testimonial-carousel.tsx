    ...
    <section className="w-full bg-[#f3f7fc] py-12 lg:py-[80px] border-t border-slate-200/60 overflow-hidden">
      <div className="page-container">
        ...
        <div className="text-center mb-10 lg:mb-[60px]">
          <span className="text-[22px] min-[375px]:text-[24px] sm:text-[26px] sm:leading-[34px] lg:text-[28px] lg:leading-[36px] font-bold text-[#162233] tracking-[0.5px] uppercase block leading-tight">
            {labels.eyebrow}
          </span>
