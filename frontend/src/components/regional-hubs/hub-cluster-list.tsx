  ...
  return (
    <>
      <div className="flex h-[640px] w-full flex-col justify-between py-8">
          ...
          >
            ...
            >
              ...
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-[3px] bg-brand shadow-sm transition-colors group-hover:bg-brand-strong">
                <span className="text-body-regular font-bold text-background">
                  {String(index + 1).padStart(2, '0')}
                </span>
              </div>
              {/* Text info */}
              <div className="flex-1 min-w-0">
                <p className="text-body-regular font-bold leading-tight text-white group-hover:text-[#00e5ff] transition-colors truncate">
                  {hub.localizedName}
                </p>
                {hub.zonesStr && (
                  <p className="mt-1.5 max-w-[240px] text-caption-responsive leading-snug text-blue-200/50 group-hover:text-blue-200/70 transition-colors truncate">
                    {hub.zonesStr}
                  </p>
                )}
              </div>
        ...
        {hubs.length === 0 && (
          <p className="text-caption-responsive leading-relaxed text-blue-200/40 text-center py-8 font-mono">
