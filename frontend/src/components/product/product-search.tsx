    ...
    >
      ...
      <form onSubmit={handleSubmit} className="flex-1 min-w-0">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-[3px] border border-gray-200 bg-white pl-10 pr-10 py-2.5 text-body-regular text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center gap-2 rounded-[3px] border border-gray-200 bg-white px-4 py-2.5 text-body-regular text-gray-700 hover:bg-gray-50 transition-colors whitespace-nowrap"
        >
            ...
            <div className="absolute right-0 top-full mt-1 z-20 w-48 rounded-[3px] border border-gray-200 bg-white shadow-lg py-1">
              {sortOptions.map((opt) => (
                <button
                  ...
                  className={`w-full text-left px-4 py-2 text-body-regular hover:bg-blue-50 transition-colors ${
      ...
      {/* Export button */}
      <button className="hidden lg:flex items-center gap-2 rounded-[3px] bg-blue-600 px-4 py-2.5 text-body-regular font-medium text-white hover:bg-blue-700 transition-colors whitespace-nowrap">
