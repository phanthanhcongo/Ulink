...
export default function ProductCardCartButton({
  ...
  return (
    <button
      ...
      onClick={handleClick}
      className={cn(
        'inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-[3px] text-caption-responsive font-extrabold transition-all shadow-2xs cursor-pointer',
        added
