  ...
  return (
    <Link
      ...
      className={cn(
        ...
        'hidden h-[42px] items-center px-5 text-[15px] sm:text-[16px] lg:text-[18px] font-semibold shadow-xs sm:inline-flex transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_0_0_1px_#1769E2,0_4px_20px_-4px_rgba(23,105,226,0.25)]'
      )}
    >
      <span>{label}</span>
    </Link>
