...
export function FooterDesktop() {
  ...
  return (
    <div className="hidden lg:grid grid-cols-[3.5fr_2.5fr_2fr_2fr_1.5fr] gap-8 xl:gap-[40px] items-start">
      {/* ── COL 1: BRAND, CONTACT & SOCIALS (4 COLS ON DESKTOP) ── */}
      <section aria-label="Thông tin ULink Industries">
        ...
        <p className="text-[12px] leading-relaxed text-[#485669]">
          {t('descLine1')}
        </p>
        ...
        <div className="mt-5 space-y-3">
          <div className="flex items-start gap-2.5 text-[12px] text-[#4d5a6b]">
            <MapPin className="h-4 w-4 shrink-0 text-[#1769e2] mt-0.5" />
            <div>
          ...
          <div className="flex items-center gap-2.5 text-[12px] text-[#4d5a6b]">
            <Mail className="h-4 w-4 shrink-0 text-[#1769e2]" />
            <a
        ...
        {/* Social Media Links */}
        <div className="mt-6">
          <p className="text-[12px] font-bold text-[#4b5666]">
            {t('connectSocials')}
          </p>
      ...
      <nav className="flex flex-col justify-between" aria-label="Về chúng tôi">
        <div>
          <div className="h-20 flex items-center mb-4">
            <Link
              href="/about"
              className="group flex w-full items-center justify-between text-[15px] xl:text-[16px] font-bold uppercase tracking-wider text-[#151b2a] transition-colors hover:text-[#1769e2] whitespace-nowrap"
            >
          ...
          <ul className="space-y-2.5 text-[15px] xl:text-[16px] whitespace-nowrap">
            <li>
        ...
        <div className="mt-8 pt-4">
          ...
          >
            <Phone className="h-4 w-4 shrink-0 text-[#1769e2]" />
            0247 309 9899
          </a>
          <div className="mt-4">
            <Image
      ...
      {/* ── COL 4: SẢN PHẨM & LANGUAGE SWITCHER ── */}
