    ...
    <section className="relative overflow-hidden rounded-[3px] border border-border bg-background">
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="relative z-10 flex flex-col justify-center px-6 py-8 sm:px-8 lg:w-[46%] lg:py-10">
          ...
          <p className="mt-5 max-w-[420px] text-caption-responsive leading-relaxed text-foreground/70">
            {t('intro')}
          </p>

          <p className="mt-4 max-w-[420px] text-caption-responsive leading-relaxed font-bold text-foreground/80">
            {t('commitment')}
          </p>
        </div>
