        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col lg:max-w-[480px]">
            ...
            <a
              ...
              className="mt-6 inline-flex w-fit items-center gap-2.5 rounded-[5px] border border-border bg-white px-5 py-2.5 text-[11px] font-normal text-brand transition-colors hover:bg-background"
            >
          ...
          <div className="w-full rounded-2xl border border-border/40 bg-white p-6 lg:w-[360px]">
