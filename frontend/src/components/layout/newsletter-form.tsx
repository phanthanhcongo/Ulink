    ...
    <div className="mt-2">
      ...
      >
        <input
          ...
          className="h-9 min-w-0 flex-1 bg-transparent px-2.5 text-caption-responsive leading-relaxed text-foreground placeholder:text-muted-foreground focus:outline-none disabled:opacity-60"
        />
        <button
          type="submit"
          disabled={status === 'loading'}
      ...
      {message && (
        <p
          className={`mt-1.5 text-caption-responsive  leading-relaxed ${
            status === 'success'
              ? 'text-green-400'
