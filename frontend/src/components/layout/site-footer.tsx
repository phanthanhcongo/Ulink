...
export async function SiteFooter() {
  ...
  return (
    <footer className="w-full bg-card text-slate-800 border-t border-slate-200">
      {/* ── MAIN FOOTER CONTENT ── */}
      <div className="mx-auto w-full max-w-[1440px] px-4 py-12 sm:px-8 lg:px-16 lg:py-16">
        {/* ── TOP SECTION: LOGO & 3 CATEGORY COLUMNS (4 COLS GRID) ── */}
        <div className="grid grid-cols-1 gap-y-6 md:gap-y-10 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="lg:col-span-4">
            <Image
              ...
              width={230}
              height={96}
              className="h-16 w-auto sm:h-[96px] sm:w-[230px] object-contain"
            />
            <p className="mt-4 sm:mt-6 text-[13px] leading-relaxed text-slate-600 sm:text-[14px]">
              {t('descLine1')}
            </p>
            <p className="mt-4 text-[12px] leading-relaxed text-slate-500 sm:text-[13px] hidden sm:block">
              {t('descLine2')}
            </p>
          </div>
          ...
          <div className="lg:col-span-3 lg:pl-8">
            ...
            <ul className="mt-4 space-y-2.5 hidden sm:block">
              <li>
                <Link
                  href="/regional-hubs"
                  className="text-[13px] text-slate-600 transition-colors hover:text-brand sm:text-[14px]"
                >
                  {t('aboutHub')}
                </Link>
              </li>
        ...
        <div className="mt-12 border-t border-slate-200 pt-10">
          <div className="grid grid-cols-1 gap-y-6 md:gap-y-10 md:grid-cols-2 lg:grid-cols-12 lg:gap-8 items-start">
            ...
            <div className="lg:col-span-4 space-y-4">
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                <a
                  ...
                  className="text-[14px] font-semibold text-slate-800 hover:text-brand sm:text-[15px]"
                >
              ...
              <div>
                ...
                <div className="mt-2 flex items-center gap-3 text-slate-800">
                  ...
                  <a
                    ...
                    className="text-[16px] font-extrabold text-slate-900 hover:text-brand sm:text-[18px]"
                  >
                    0247 309 9899
                  </a>
                </div>
            ...
            {/* Block 3: App Download & QR Code (3/12 COLS) - Hidden on mobile/tablet, visible on desktop */}
            <div className="hidden lg:block lg:col-span-3">
              <div className="inline-flex flex-col items-center rounded-[5px] border border-slate-200 bg-white p-4 shadow-sm">
