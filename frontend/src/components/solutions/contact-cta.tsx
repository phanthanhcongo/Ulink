    ...
    <section className="w-full bg-white border-t border-b border-slate-100 py-10 mt-16 lg:mt-24">
      <div className="page-container flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-4 shrink-0 w-full sm:w-auto">
          <Link
            href="/contact"
            className="inline-flex h-11 items-center justify-center rounded-[3px] border border-[#1769E2] bg-white px-6 text-caption-responsive leading-relaxed font-bold text-[#1769E2] hover:bg-[#EBF3FE] transition-colors w-1/2 sm:w-auto text-center"
          >
            {t('contactCta.callNow')}
          </Link>
          <Link
            href="/contact"
            className="inline-flex h-11 items-center justify-center rounded-[3px] bg-[#1769E2] px-6 text-caption-responsive leading-relaxed font-bold text-white hover:bg-[#1257BD] transition-colors w-1/2 sm:w-auto text-center"
          >
