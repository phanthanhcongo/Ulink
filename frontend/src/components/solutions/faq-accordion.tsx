...
export default function FaqAccordion({ sectionTitle, sectionSubtitle, items }: FaqAccordionProps) {
  ...
  return (
    <section className="w-full bg-[#F2F4F8] border-t border-slate-100/60 py-12 lg:py-16 mt-16 lg:mt-24">
          ...
          {items.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="text-body-regular font-bold text-primary pr-4 leading-snug">
                ...
                >
                  <div className="overflow-hidden">
                    <div className="px-6 sm:px-8 pb-6 text-caption-responsive leading-relaxed text-slate-500 font-medium">
                      {item.answer}
                    </div>
                  </div>
                </div>
