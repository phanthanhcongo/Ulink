...
import { Building2, Factory, Check, ArrowRight } from 'lucide-react';
  ...
  return (
    <section className="w-full mt-16 lg:mt-24 border-t border-slate-100 pt-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-0">
        {/* FDI Enterprise Card */}
        <div className="bg-[#4F70B5] text-white p-8 sm:p-12 lg:p-16 flex justify-end w-full">
          <div className="w-full max-w-[640px] flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <h3 className="text-body-regular font-bold tracking-tight">
              ...
              <ul className="space-y-4 mb-10">
                {bullets.map((bullet, idx) => (
                  <li
                    key={idx}
                    className="flex items-start gap-3 text-caption-responsive leading-relaxed font-medium"
                  >
            ...
            <div className="flex justify-center pt-2">
              <Link
                href="/quick-order"
                className="inline-flex items-center justify-center gap-2 w-full max-w-[200px] bg-white text-[#4F70B5] hover:bg-slate-50 px-6 py-2.5 rounded-[3px] text-caption-responsive leading-relaxed font-bold shadow-sm transition-all hover:scale-[1.01]"
              >
          ...
          <div className="w-full max-w-[640px] flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <h3 className="text-body-regular font-bold text-primary tracking-tight">
              ...
              <ul className="space-y-4 mb-10">
                {bullets.map((bullet, idx) => (
                  <li
                    key={idx}
                    className="flex items-start gap-3 text-caption-responsive leading-relaxed font-medium text-slate-650"
                  >
            ...
            <div className="flex justify-center pt-2">
              <Link
                href="/quick-order"
                className="inline-flex items-center justify-center gap-2 w-full max-w-[200px] bg-brand hover:bg-brand-strong text-white px-6 py-2.5 rounded-[3px] text-caption-responsive leading-relaxed font-bold shadow-sm transition-all hover:scale-[1.01]"
              >
                {t('customerSegments.viewDetails')}
                <ArrowRight className="h-4 w-4" />
              </Link>
