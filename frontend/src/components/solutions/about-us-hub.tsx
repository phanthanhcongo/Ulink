  ...
  return (
    <section className="w-full mt-16 lg:mt-24 border-t border-slate-100 pt-16">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
        ...
        <Link
          href="/about"
          className="inline-flex items-center gap-1.5 text-caption-responsive font-bold text-blue-600 hover:text-blue-700 transition-colors shrink-0 md:mb-1"
        >
        ...
        <div className="lg:col-span-7 bg-card/65 rounded-[3px] border border-slate-100 p-6 sm:p-8 flex flex-col justify-between">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 bg-[#F2F4F8] rounded-[3px] border border-slate-100/80 divide-y sm:divide-y-0 sm:divide-x divide-slate-200/60">
            ...
            <div className="flex items-center gap-2.5 sm:px-2 pt-2 first:pt-0 sm:pt-0">
              ...
              <span className="text-caption-responsive text-slate-600 font-bold leading-tight">
            ...
            <div className="flex items-center gap-2.5 sm:pl-4 pt-2 sm:pt-0">
              <div className="w-7 h-7 rounded-full bg-white flex items-center justify-center shrink-0">
                <span className="text-blue-600 font-black text-body-regular">$</span>
              </div>
              <span className="text-caption-responsive text-slate-600 font-bold leading-tight">
            ...
            <div className="flex items-center gap-2.5 sm:pl-4 pt-2 sm:pt-0">
              <div className="flex flex-col items-start gap-0.5 shrink-0">
                <div className="flex items-center text-caption-responsive text-amber-400 tracking-wider">
                  <span>★</span>
                  <span>★</span>
                  <span>★</span>
                  <span>★</span>
