      ...
      <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-2.5 sm:space-y-3">
            ...
            <div className="grid grid-cols-1 gap-2.5 sm:gap-3 sm:grid-cols-2">
              ...
              <div>
                ...
                <select name="subject" required className={`${controlClass} w-full text-slate-700`}>
            ...
            {error && (
              <p className="rounded-[3px] bg-rose-50 px-3 py-2 text-caption-responsive font-medium text-rose-700">
                {error}
              </p>
            )}
        ...
        <Card className="lg:col-span-3 flex flex-col justify-between gap-3 sm:gap-4 p-4 sm:p-6">
          ...
          <a
            ...
            className="text-caption-responsive font-semibold text-blue-600 hover:underline"
          >
