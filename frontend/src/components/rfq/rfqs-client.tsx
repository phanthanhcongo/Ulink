  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-border/40 pb-4">
        <h2 className="text-card-title font-semibold text-foreground">Danh sách yêu cầu</h2>
        <Link
          href="/quick-order"
          className="inline-flex items-center justify-center gap-2 rounded-[3px] bg-brand px-4 py-2.5 text-body-regular font-semibold text-white shadow-md hover:bg-brand/90 hover:scale-[1.01] active:scale-[0.99] transition-all shrink-0"
        >
      ...
      {showSuccessToast && (
        <div className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-[3px] border border-emerald-200/50 bg-emerald-50 px-4 py-3 text-emerald-800 shadow-lg animate-in fade-in slide-in-from-bottom-5 duration-300 dark:bg-emerald-950/20 dark:text-emerald-400 dark:border-emerald-500/20">
          ...
          <span className="text-body-regular font-medium">Gửi yêu cầu báo giá thành công!</span>
        </div>
      )}
      ...
      <div className="grid gap-4 rounded-[3px] border border-border/70 bg-card p-4 shadow-sm md:grid-cols-12 md:items-center">
        ...
        <div className="relative md:col-span-5">
          ...
          <input
            ...
            className="w-full rounded-[3px] border border-border/80 bg-background/50 py-2 pl-10 pr-4 text-body-regular outline-none transition-all placeholder:text-muted-foreground focus:border-brand focus:ring-1 focus:ring-brand"
          />
          {searchQuery && (
            <button
        ...
        <div className="md:col-span-3">
          <select
            ...
            className="w-full rounded-[3px] border border-border/80 bg-background/50 px-3 py-2 text-body-regular outline-none transition-all focus:border-brand focus:ring-1 focus:ring-brand"
          >
      ...
      {loading ? (
        <div className="flex h-64 items-center justify-center rounded-[3px] border border-border/70 bg-card/60 backdrop-blur">
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-body-regular text-muted-foreground">Đang tải danh sách yêu cầu báo giá...</p>
          </div>
        </div>
      ) : error ? (
        <div className="flex h-64 items-center justify-center rounded-[3px] border border-rose-100 bg-rose-50/50 p-6 text-center dark:bg-rose-950/10 dark:border-rose-900/30">
          <div className="flex flex-col items-center gap-3 max-w-md">
            ...
            <p className="text-body-regular font-medium text-rose-900 dark:text-rose-400">{error}</p>
          </div>
        </div>
        ...
        <div className="flex h-64 flex-col items-center justify-center rounded-[3px] border border-dashed border-border/80 bg-card p-6 text-center">
          ...
          <h3 className="mt-4 text-body-regular font-semibold text-foreground">Không tìm thấy RFQ nào</h3>
          <p className="mt-1 text-caption-responsive text-muted-foreground max-w-xs">
            {rfqs.length === 0
        ...
        <div className="overflow-hidden rounded-[3px] border border-border/70 bg-card shadow-sm">
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-left text-body-regular">
              <thead className="bg-muted/40 text-caption-responsive uppercase tracking-wider text-muted-foreground border-b border-border/70">
                <tr>
                    ...
                    <tr key={rfq.id} className="transition-colors hover:bg-muted/20">
                      ...
                      <td className="px-6 py-4 text-muted-foreground">
                        ...
                        {rfq.scheduled_delivery && (
                          <div className="mt-1 flex items-center gap-1 text-caption-responsive font-medium text-brand">
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={cn(
                            'inline-flex items-center rounded-full border px-2.5 py-0.5 text-caption-responsive font-semibold',
                            statusInfo.classes
                          )}
                        >
                          {statusInfo.label}
                      ...
                      <td className="px-6 py-4 text-right">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 rounded-[3px] border border-border px-3 py-1.5 text-caption-responsive font-medium text-foreground hover:border-brand hover:text-brand hover:bg-brand/5 transition-all"
                        >
          ...
          <div className="relative w-full max-w-2xl overflow-hidden rounded-[3px] border border-border/80 bg-card shadow-xl animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex items-center justify-between border-b border-border/80 px-6 py-4 bg-muted/30">
              <div>
                ...
                <p className="text-caption-responsive text-muted-foreground mt-0.5">
            ...
            <div className="max-h-[70vh] overflow-y-auto p-6 space-y-6">
              ...
              <div className="flex items-center justify-between rounded-[3px] border border-border/60 bg-muted/25 px-4 py-3">
                <span className="text-body-regular text-muted-foreground">Trạng thái xử lý:</span>
                <span
                  className={cn(
                    'inline-flex items-center rounded-full border px-3 py-1 text-caption-responsive font-semibold',
              ...
              <div className="space-y-3">
                ...
                <div className="grid gap-3 sm:grid-cols-2 text-body-regular">
                  <div className="space-y-1">
                    <span className="text-caption-responsive text-muted-foreground block">Tên doanh nghiệp</span>
                    <span className="font-medium text-foreground">{selectedRfq.company}</span>
                  </div>
                  <div className="space-y-1">
                    <span className="text-caption-responsive text-muted-foreground block">Người đại diện</span>
                  ...
                  <div className="space-y-1 flex items-start gap-2 pt-1">
                    ...
                    <div>
                      <span className="text-caption-responsive text-muted-foreground block">Email</span>
                      <a
                  ...
                  <div className="space-y-1 flex items-start gap-2 pt-1">
                    ...
                    <div>
                      <span className="text-caption-responsive text-muted-foreground block">Số điện thoại</span>
                      <a
                  ...
                  {selectedRfq.industry && (
                    <div className="space-y-1 flex items-start gap-2 pt-1 sm:col-span-2">
                      ...
                      <div>
                        <span className="text-caption-responsive text-muted-foreground block">Ngành nghề</span>
              ...
              {selectedRfq.assigned_sales && typeof selectedRfq.assigned_sales === 'object' && (
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 rounded-[3px] border border-border/60 bg-muted/20 p-3">
                    ...
                    <div>
                      <div className="text-body-regular font-semibold text-foreground">
                      ...
                      {selectedRfq.assigned_sales.email && (
                        <div className="text-caption-responsive text-muted-foreground flex items-center gap-1.5 mt-0.5">
              ...
              <div className="space-y-3">
                ...
                <div className="grid gap-3 sm:grid-cols-2 text-body-regular">
                  <div className="space-y-1">
                    <span className="text-caption-responsive text-muted-foreground block">
              ...
              <div className="space-y-3">
                ...
                {selectedRfq.line_items &&
                  ...
                  <p className="text-body-regular text-muted-foreground italic">
              ...
              <div className="space-y-2">
                <h3 className="text-body-regular font-semibold text-foreground border-b border-border/50 pb-1.5">
                  Ghi chú / Yêu cầu thêm
                </h3>
                <div className="rounded-[3px] border border-border/60 bg-muted/20 p-4 text-body-regular text-foreground/90 whitespace-pre-wrap leading-relaxed">
              ...
              {selectedRfq.status === 'approved' && selectedRfq.approval_note && (
                <div className="space-y-2">
                  <h3 className="text-body-regular font-semibold text-emerald-600 border-b border-border/50 pb-1.5">
                    Ghi chú duyệt
                  </h3>
                  <div className="rounded-[3px] border border-emerald-200/50 bg-emerald-50/50 p-4 text-body-regular text-emerald-800 whitespace-pre-wrap leading-relaxed dark:bg-emerald-900/10 dark:text-emerald-400">
              ...
              {selectedRfq.status === 'rejected' && selectedRfq.reject_reason && (
                <div className="space-y-2">
                  <h3 className="text-body-regular font-semibold text-rose-600 border-b border-border/50 pb-1.5">
                    Lý do từ chối
                  </h3>
                  <div className="rounded-[3px] border border-rose-200/50 bg-rose-50/50 p-4 text-body-regular text-rose-800 whitespace-pre-wrap leading-relaxed dark:bg-rose-900/10 dark:text-rose-400">
            ...
            <div className="flex justify-between items-center border-t border-border/80 px-6 py-4 bg-muted/30">
                ...
                {selectedRfq.status === 'pending' && (
                  <>
                    <button
                      ...
                      className="rounded-[3px] bg-emerald-600 px-4 py-2 text-body-regular font-medium text-white hover:bg-emerald-700 transition-all shadow-sm"
                    >
                      Duyệt
                    </button>
                    <button
                      ...
                      className="rounded-[3px] bg-rose-600 px-4 py-2 text-body-regular font-medium text-white hover:bg-rose-700 transition-all shadow-sm"
                    >
                      Từ chối
                    </button>
                  </>
              ...
              <button
                type="button"
                onClick={() => setSelectedRfq(null)}
                className="rounded-[3px] border border-border bg-card px-4 py-2 text-body-regular font-medium text-foreground hover:bg-muted transition-all"
              >
                Đóng
              </button>
            </div>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md overflow-hidden rounded-[3px] border border-border/80 bg-card shadow-xl animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleActionSubmit} className="p-6 space-y-4">
              {actionError && (
                <div className="rounded-[3px] border border-rose-100 bg-rose-50/50 p-3 text-caption-responsive text-rose-800 flex items-center gap-2">
                  <AlertCircle className="h-4 w-4 text-rose-500 shrink-0" />
                  <span>{actionError}</span>
                </div>
              )}
              <div className="space-y-2">
                <label className="text-body-regular font-medium text-foreground block">
                ...
                <textarea
                  ...
                  className="w-full rounded-[3px] border border-border/80 bg-background px-3 py-2 text-body-regular outline-none transition-all focus:border-brand focus:ring-1 focus:ring-brand resize-none"
                />
              </div>
              <div className="flex justify-end gap-3 pt-4">
                ...
                <button
                  ...
                  disabled={actionSubmitting}
                  className={cn(
                    'inline-flex items-center gap-1.5 rounded-[3px] px-5 py-2 text-body-regular font-semibold text-white shadow transition-all',
                    actionModalType === 'approve'
      ...
      {isCreateOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-2xl overflow-hidden rounded-[3px] border border-border/80 bg-card shadow-xl animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex items-center justify-between border-b border-border/80 px-6 py-4 bg-muted/30">
              <div>
                <h2 className="text-card-title font-semibold text-foreground flex items-center gap-2">
            ...
            <form onSubmit={handleSubmit} className="max-h-[70vh] overflow-y-auto p-6 space-y-6">
              {formError && (
                <div className="rounded-[3px] border border-rose-100 bg-rose-50/50 p-3 text-caption-responsive text-rose-800 flex items-center gap-2 dark:bg-rose-950/10 dark:text-rose-400 dark:border-rose-900/30">
                  <AlertCircle className="h-4 w-4 text-rose-500 shrink-0" />
                  <span>{formError}</span>
                </div>
              )}
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-1">
                    <label className="text-caption-responsive font-medium text-muted-foreground block">
                      Tên công ty *
                    </label>
                    <input
                      type="text"
                      ...
                      className={cn(
                        'w-full rounded-[3px] border bg-background px-3 py-2 text-body-regular outline-none transition-all focus:border-brand focus:ring-1 focus:ring-brand',
                        formFieldErrors.company ? 'border-rose-500' : 'border-border/80'
                      )}
                    />
                    {formFieldErrors.company && (
                      <span className="text-caption-responsive text-rose-500 block font-medium">
                        {formFieldErrors.company}
                      </span>
                    )}
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <label
                      ...
                      className="text-body-regular font-medium text-foreground cursor-pointer select-none"
                    >
                      Lên lịch giao hàng (Scheduled Delivery)
                    </label>
                  </div>
                  ...
                  {formScheduled && (
                    <div className="space-y-1 animate-in fade-in slide-in-from-top-2 duration-200 max-w-sm">
                      ...
                      <input
                        ...
                        className={cn(
                          'w-full rounded-[3px] border bg-background px-3 py-2 text-body-regular outline-none transition-all focus:border-brand focus:ring-1 focus:ring-brand font-medium',
              ...
              {/* Section 4: Notes */}
              <div className="space-y-2">
                <label className="text-caption-responsive font-medium text-muted-foreground block">Ghi chú</label>
                <textarea
                  rows={3}
                  value={formMessage}
                  onChange={(e) => {
                  ...
                  className={cn(
                    'w-full rounded-[3px] border bg-background px-3 py-2 text-body-regular outline-none transition-all focus:border-brand focus:ring-1 focus:ring-brand resize-none placeholder:text-muted-foreground',
              ...
              <div className="flex justify-end gap-3 border-t border-border/80 pt-4 bg-background">
                <button
                  ...
                  onClick={() => setIsCreateOpen(false)}
                  disabled={submitting}
                  className="rounded-[3px] border border-border bg-card px-4 py-2 text-body-regular font-medium text-foreground hover:bg-muted transition-all disabled:opacity-50"
                >
                  Hủy
                </button>
                <button
                  type="submit"
                  disabled={submitting}
                  className="inline-flex items-center gap-1.5 rounded-[3px] bg-brand px-5 py-2 text-body-regular font-semibold text-white shadow hover:bg-brand/90 transition-all disabled:opacity-75"
                >
