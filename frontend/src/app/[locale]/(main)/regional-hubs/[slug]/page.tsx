    ...
    <div className="w-full bg-background py-8 sm:py-12">
      <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-8 lg:px-12 xl:px-16">
        ...
        <Breadcrumb
          ...
          items={[
            {
              label: isVi ? 'Trang chủ' : isJa ? 'ホーム' : 'Home',
              href: '/'
            },
            {
              label: isVi ? 'Cụm công nghiệp' : isJa ? '工業クラスター' : 'Clusters',
              href: '/regional-hubs'
            },
            {
              label: hubName
          ...
          <div className="relative z-10 flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            ...
            <div className="flex-1">
              <div className="flex flex-wrap items-center gap-3">
                <span className="inline-flex items-center gap-1 rounded bg-primary px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-brand shadow-inner ring-1 ring-brand/20">
                  <Sparkles className="h-3 w-3 text-brand" />
                  {hub.hub_code || 'HUB'}
                </span>
                <span
                  className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-xs font-medium ${hub.operating_status === 'active'
            ...
            <div className="mt-5 flex-1 flex flex-col justify-between gap-6">
              ...
              <div>
                ...
                <div className="relative h-4 w-full rounded-full bg-slate-100 overflow-hidden flex border border-slate-200/50 shadow-inner">
                  ...
                  />
                  <div
                    className="h-full bg-emerald-500/25 transition-all"
