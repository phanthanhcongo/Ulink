...
const CATEGORIES_MASTER: Record<string, CategoryInfo> = {
  'cleanroom-consumables': {
    ...
    description:
      'Trọn bộ trang thiết bị vật tư tiêu hao phòng sạch đạt tiêu chuẩn ISO 14644-1 từ Class 10 đến Class 100,000 cho các nhà máy điện tử & bán dẫn.',
    subCategories: [
  ...
  'cleanroom-gloves': {
    ...
    description:
      'Găng tay Nitrile, Latex, PU phủ đầu ngón & phủ lòng bàn tay chống tĩnh điện ESD, không bột, siêu sạch không để lại ion kim loại.',
  ...
  'cleanroom-wipers': {
    ...
    description:
      'Khăn lau Wiper 1009D, Microfiber 4004 cắt laser chống phát sinh xơ sợi, độ thấm hút dung môi IPA tối đa.',
    parentName: 'Vật tư phòng sạch'
  },
  'cleanroom-apparel': {
    id: 4,
    ...
    description:
      'Quần áo phòng sạch liền thân có nón, áo blouse, nón trùm đầu, giày boot PVC/PU dệt sợi carbon chống tĩnh điện.',
    parentName: 'Vật tư phòng sạch'
  },
  'cleanroom-masks': {
    id: 5,
    ...
    description:
      'Khẩu trang 3 lớp ES/MB không xơ xơ, khẩu trang than hoạt tính lọc bụi mịn 0.1 micron trong phòng sơn và phòng lab.',
    parentName: 'Vật tư phòng sạch'
  },
  'industrial-packaging': {
    ...
    description:
      'Túi nhôm ESD Shielding Bag, màng PE quấn pallet, thùng nhựa Danpla PP sóng, khay nhựa định hình EPE chịu lực.',
    subCategories: [
  ...
  'esd-supplies': {
    ...
    slug: 'esd-supplies',
    description:
      'Dây đeo cổ tay chống tĩnh điện, thảm cao su ESD 2 lớp, nhíp inox chống tĩnh điện, quạt khử ion Ionizer khử nạp tĩnh.',
    subCategories: [
  ...
  'cleanroom-chemicals': {
    ...
    description:
      'Dung dịch cồn IPA 99.9% Cleanroom Grade, dung dịch tẩy rửa bề mặt bo mạch SMT, chất phủ bảo vệ chống ẩm.',
    parentName: 'Vật tư phòng sạch'
  }
};
