...
import PharmaceuticalClient from './pharmaceutical-client';
...
const CANONICAL_SLUG = 'pharmaceutical-cosmetics';
const ROUTE_SLUG = 'pharmaceutical';
...
export default async function PharmaceuticalIndustryPage({ params: { locale } }: Props) {
