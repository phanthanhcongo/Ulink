  ...
  return (
    <div className="min-h-screen bg-white text-[#141414] font-sans">
      ...
      <IndustryCategorySection
        ...
        title={isVi ? 'Nhóm sản phẩm chuyên dụng ngành Dược' : isJa ? '医薬品専用製品グループ' : 'Specialized Products for Pharmaceutical'}
      ...
      <IndustryCategorySection
        id="packaging"
        tagText={isVi ? 'SẢN PHẨM ĐÓNG GÓI' : translations.packagingSol}
        title={isVi ? 'Bao bì & đóng gói vô trùng' : isJa ? '滅菌包装＆パッケージング' : 'Sterile Packaging & Wrapping'}
