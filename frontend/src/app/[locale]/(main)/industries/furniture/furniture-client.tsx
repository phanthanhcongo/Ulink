          ...
          <div className="lg:col-span-7 space-y-6 flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <div className="text-[15px] lg:text-[16px] leading-[24px] lg:leading-[26px] text-[#495057] font-normal space-y-4 pt-2">
                <p>
                  Sản xuất và xuất khẩu gỗ nội thất yêu cầu khả năng chống trầy xước bề mặt sơn, chống va đập góc cạnh và chống ẩm mốc khi vận chuyển đường biển. ULink mang tới các màng bảo vệ xốp PE, màng co và vật tư chuyên dụng cho xưởng sản xuất gỗ.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-5">
                {(industryData.whyUsItems || [
                  { title: 'Chống trầy xước tuyệt đối', desc: 'Màng foam PE mịn màng bảo vệ lớp sơn cao cấp.', iconName: 'ShieldCheck' },
                  { title: 'Cung ứng vật tư số lượng lớn', desc: 'Bao phủ rộng khắp các làng nghề và KCN chế biến gỗ.', iconName: 'Package' },
                  { title: 'Giao hàng đúng hẹn', desc: 'Đảm bảo đúng lịch đóng container xuất khẩu.', iconName: 'Truck' },
                  { title: 'Tư vấn quy cách', desc: 'Giải pháp bọc lót theo kích thước đa dạng của sản phẩm.', iconName: 'User' }
                ]).map((item, idx) => {
      ...
      <section id="cleanroom" className="scroll-mt-16 py-16 lg:py-20 w-full bg-white border-t border-[#DDE1E6]">
        <div className="page-container space-y-10">
          <div className="space-y-2 max-w-5xl">
            ...
            <h2 className="text-[26px] sm:text-[32px] lg:text-[38px] lg:leading-[46px] font-bold text-[#141414] tracking-tight">
              {isVi ? 'Nhóm sản phẩm vật tư xưởng gỗ & sơn nội thất' : isJa ? '木工・塗料工場用資材グループ' : 'Woodworking Consumables Products'}
            </h2>
      ...
      <section id="packaging" className="scroll-mt-16 py-16 lg:py-20 w-full bg-white border-t border-[#DDE1E6]">
        <div className="page-container space-y-10">
          <div className="space-y-2 max-w-5xl">
            ...
            <h2 className="text-[26px] sm:text-[32px] lg:text-[38px] lg:leading-[46px] font-bold text-[#141414] tracking-tight">
              {isVi ? 'Bao bì & Đóng gói sản phẩm gỗ xuất khẩu' : isJa ? '輸出用木製品包装＆パッケージング' : 'Export Furniture Packaging'}
            </h2>
            <p className="text-[15px] lg:text-[16px] leading-relaxed text-[#495057] font-normal">
