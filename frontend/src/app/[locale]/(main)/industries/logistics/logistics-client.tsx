  ...
  return (
    <div className="min-h-screen bg-white text-[#141414] font-sans">
      ...
      <IndustryCategorySection
        ...
        title={isVi ? 'Nhóm sản phẩm bảo hộ kho vận' : isJa ? '倉庫・物流用保護具グループ' : 'Warehouse Safety Products'}
      ...
      <IndustryCategorySection
        ...
        title={isVi ? 'Màng quấn Pallet & Bao bì đóng kiện' : isJa ? 'パレットフィルム＆梱包資材' : 'Pallet Film & Bulk Packaging'}
