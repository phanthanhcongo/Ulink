...
import { TargetSegments, PartnersCertifications, WorkingProcess, ResourcesNews } from '@/components/home';
  ...
  const industriesList = [
    ...
    },
    {
      ...
      bullets: isVi
        ...
        : isJa
          ? ['標準的な医療用マスク＆無菌手袋', '使い捨て手術用保護具', '医療用専用包装＆廃棄物容器']
          : [
    ...
    },
    {
      ...
      name: isVi
        ...
        : isJa
          ? '精密機械＆HVAC'
          : 'Precision Engineering & HVAC',
      icon: 'Wrench',
      image: '/images/Career/06 (5).png',
      description: isVi
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 pb-16">
      ...
      <div className="relative overflow-hidden bg-slate-900 min-h-[420px] lg:min-h-[480px] shadow-sm flex items-stretch w-full">
        ...
        <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 p-8 sm:p-12 lg:p-16 flex flex-col justify-between">
          ...
          <Breadcrumb
            ...
            items={[
              { label: content.breadcrumbHome, href: '/' },
      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-8 lg:px-12 xl:px-16 py-12 lg:py-16 flex flex-col gap-12">
        ...
        {/* 6-Card Grid */}
        <IndustryGrid industriesList={industriesList} viewDetailsLabel={content.viewDetails} />
      </div>
      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-8 lg:px-12 xl:px-16 py-12 lg:py-16">
