  ...
  return (
    <div className="min-h-screen bg-white text-[#141414] font-sans">
      ...
      <IndustryCategorySection
        ...
        title={isVi ? 'Nhóm sản phẩm chuyên dụng ngành Thực phẩm & Đồ uống' : isJa ? '食品・飲料業界向け専用製品グループ' : 'Specialized Products for Food & Beverage'}
      ...
      <IndustryCategorySection
        ...
        title={isVi ? 'Bao bì & Đóng gói thực phẩm' : isJa ? '食品用包装＆パッケージング' : 'Food Packaging & Wrapping'}
