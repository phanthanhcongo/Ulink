          ...
          <div className="lg:col-span-7 space-y-6 flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <div className="text-[15px] lg:text-[16px] leading-[24px] lg:leading-[26px] text-[#495057] font-normal space-y-4 pt-2">
                <p>
                  Các dự án thi công công trình và nhà máy yêu cầu đồ bảo hộ lao động đạt chuẩn, màng che chắn bụi bẩn công trình và vật tư đóng gói nguyên vật liệu dầy dặn. ULink đồng hành cùng các nhà thầu với nguồn cung bền vững.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-5">
                {(industryData.whyUsItems || [
                  { title: 'Tiêu chuẩn bảo hộ an toàn', desc: 'Đạt kiểm định an toàn lao động công trình.', iconName: 'ShieldCheck' },
                  { title: 'Cung ứng khối lượng lớn', desc: 'Đáp ứng liên tục cho các đại công trường.', iconName: 'Package' },
                  { title: 'Giao hàng tận chân công trình', desc: 'Đúng cam kết tiến độ thi công.', iconName: 'Truck' },
                  { title: 'Tư vấn giải pháp', desc: 'Kỹ sư hỗ trợ chọn vật tư phù hợp đặc thụ dự án.', iconName: 'User' }
                ]).map((item, idx) => {
      ...
      <section id="cleanroom" className="scroll-mt-16 py-16 lg:py-20 w-full bg-white border-t border-[#DDE1E6]">
        <div className="page-container space-y-10">
          <div className="space-y-2 max-w-5xl">
            ...
            <h2 className="text-[26px] sm:text-[32px] lg:text-[38px] lg:leading-[46px] font-bold text-[#141414] tracking-tight">
              {isVi ? 'Nhóm sản phẩm vật tư & bảo hộ công trình' : isJa ? '建設・工事用資材・保護具グループ' : 'Construction Protection & Consumables'}
            </h2>
      ...
      <section id="packaging" className="scroll-mt-16 py-16 lg:py-20 w-full bg-white border-t border-[#DDE1E6]">
        <div className="page-container space-y-10">
          <div className="space-y-2 max-w-5xl">
            ...
            <h2 className="text-[26px] sm:text-[32px] lg:text-[38px] lg:leading-[46px] font-bold text-[#141414] tracking-tight">
              {isVi ? 'Bao bì & Đóng gói vật liệu xây dựng' : isJa ? '建設資材用包装＆パッケージング' : 'Construction Material Packaging'}
            </h2>
            <p className="text-[15px] lg:text-[16px] leading-relaxed text-[#495057] font-normal">
