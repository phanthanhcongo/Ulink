  ...
  return (
    <div className="min-h-screen bg-white text-[#141414] font-sans">
      ...
      <IndustryCategorySection
        ...
        title={isVi ? 'Nhóm sản phẩm vật tư & bảo hộ công trình' : isJa ? '建設・工事用資材・保護具グループ' : 'Construction Protection & Consumables'}
      ...
      <IndustryCategorySection
        ...
        title={isVi ? 'Bao bì & Đóng gói vật liệu xây dựng' : isJa ? '建設資材用包装＆パッケージング' : 'Construction Material Packaging'}
