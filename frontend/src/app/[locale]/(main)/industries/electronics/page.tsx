...
import ElectronicsClient from './electronics-client';
...
const CANONICAL_SLUG = 'electronics';
const ROUTE_SLUG = 'electronics';
...
export default async function ElectronicsIndustryPage({ params: { locale } }: Props) {
