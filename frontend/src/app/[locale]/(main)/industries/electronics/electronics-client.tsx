  ...
  return (
    <div className="min-h-screen bg-white text-[#141414] font-sans">
      ...
      <IndustryCategorySection
        ...
        title={isVi ? 'Nhóm sản phẩm chuyên dụng ngành Điện tử' : isJa ? '電子・半導体業界向け専用製品グループ' : 'Specialized Products for Electronics'}
      ...
      <IndustryCategorySection
        ...
        title={isVi ? 'Bao bì & Khay nhựa linh kiện ESD' : isJa ? '電子部品用ESD包装＆トレー' : 'ESD Component Packaging & Trays'}
