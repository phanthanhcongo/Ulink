...
export const RELATION_DEFS = [
  ...
  { collection: 'inventory_stock', field: 'sku', related_collection: 'product_skus' },
  { collection: 'inventory_stock', field: 'hub', related_collection: 'regional_hubs' },
  { collection: 'inventory_movements', field: 'sku', related_collection: 'product_skus' },
  { collection: 'inventory_movements', field: 'hub', related_collection: 'regional_hubs' },
  { collection: 'inventory_movements', field: 'order_id', related_collection: 'orders' },
  { collection: 'inventory_movements', field: 'performed_by', related_collection: 'directus_users' },
