...
-- Note: UNIQUE(sku, hub) constraint in CREATE TABLE already provides this index
...
-- Note: Initial inventory seed data has been moved to seed/inventory_seed.mjs
-- Migration files should only contain schema changes.
